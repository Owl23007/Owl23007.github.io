...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><h3 id="单例模式的-uml-表示" tabindex="-1">单例模式的 UML 表示 <a class="header-anchor" href="#单例模式的-uml-表示" aria-label="Permalink to &quot;单例模式的 UML 表示&quot;">​</a></h3><pre class="mermaid mermaid-19">classDiagram
    class Singleton {
        -instance: Singleton
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">        }</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    }</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><h5 id="uml-表示" tabindex="-1">UML 表示 <a class="header-anchor" href="#uml-表示" aria-label="Permalink to &quot;UML 表示&quot;">​</a></h5><pre class="mermaid mermaid-20">classDiagram
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><h5 id="uml-表示-1" tabindex="-1">UML 表示 <a class="header-anchor" href="#uml-表示-1" aria-label="Permalink to &quot;UML 表示&quot;">​</a></h5><pre class="mermaid mermaid-21">classDiagram
    class ShapeFactory {
        +create(): Shape
    }
    class CircleFactory {
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><h5 id="uml-表示-2" tabindex="-1">UML 表示 <a class="header-anchor" href="#uml-表示-2" aria-label="Permalink to &quot;UML 表示&quot;">​</a></h5><pre class="mermaid mermaid-22">classDiagram
    %% ===== 抽象产品（用抽象类风格表示接口）=====
    class Button {
        +render(): void
    }
