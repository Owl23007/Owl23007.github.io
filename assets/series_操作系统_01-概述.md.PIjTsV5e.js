import{f as t,o as r,c as n,ah as i}from"./chunks/framework.5bt9HFMa.js";const p=JSON.parse('{"title":"01-操作系统概述","description":"操作系统概述，包括定义、特征、发展历程、运行机制及资源管理功能。","frontmatter":{"title":"01-操作系统概述","date":"2025-12-11T00:00:00.000Z","tags":["操作系统","计算机基础"],"description":"操作系统概述，包括定义、特征、发展历程、运行机制及资源管理功能。","author":"沃以","publish":true,"next":{"text":"02-进程","link":"/series/操作系统/02-进程.html"},"prev":{"text":"目录","link":"/series/操作系统/index"}},"headers":[],"relativePath":"series/操作系统/01-概述.md","filePath":"series/操作系统/01-概述.md","lastUpdated":1777391754000}'),s={name:"series/操作系统/01-概述.md"};function o(e,l,a,g,u,d){return r(),n("div",null,l[0]||(l[0]=[i(`<h1 id="_01-操作系统概述" tabindex="-1">01-操作系统概述 <a class="header-anchor" href="#_01-操作系统概述" aria-label="Permalink to &quot;01-操作系统概述&quot;">​</a></h1><pre class="mermaid mermaid-18">mindmap
  root((操作系统概述))
    特征
      并发
      共享
