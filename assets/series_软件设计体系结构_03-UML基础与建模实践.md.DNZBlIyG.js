...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><h5 id="示例补充" tabindex="-1">示例补充 <a class="header-anchor" href="#示例补充" aria-label="Permalink to &quot;示例补充&quot;">​</a></h5><pre class="mermaid mermaid-15">classDiagram
    ...
    ShowError --&gt; Input
    LoginSuccess --&gt; End(((End)))</pre><h3 id="_3-泳道图-swimlanes" tabindex="-1">3. 泳道图（Swimlanes） <a class="header-anchor" href="#_3-泳道图-swimlanes" aria-label="Permalink to &quot;3. 泳道图（Swimlanes）&quot;">​</a></h3><p><strong>泳道图</strong>不是一种独立的图，而是活动图的一种**分区（Partition）**表现形式。</p><ul><li><strong>定义</strong>：通过垂直或水平的线条将活动图划分为若干区域（泳道）。</li><li><strong>作用</strong>：明确每个活动是由<strong>谁</strong>（哪个角色、部门、系统或类）负责执行的。</li><li><strong>结构</strong>：每个泳道代表一个责任主体。</li></ul><h4 id="泳道图示例-请假审批流程" tabindex="-1">泳道图示例：请假审批流程 <a class="header-anchor" href="#泳道图示例-请假审批流程" aria-label="Permalink to &quot;泳道图示例：请假审批流程&quot;">​</a></h4><p>以下示例展示了通过互联网访问摄像机监视设备并显示摄像机视图功能的泳道图：</p><p><img src="`+e+'" alt="alt text"></p><h3 id="_4-应用场景" tabindex="-1">4. 应用场景 <a class="header-anchor" href="#_4-应用场景" aria-label="Permalink to &quot;4. 应用场景&quot;">​</a></h3><ul><li><strong>业务建模</strong>：梳理跨部门的业务流程（如订单处理、采购流程），泳道图在此场景下非常有用。</li><li><strong>逻辑设计</strong>：描述复杂算法或方法的内部执行逻辑。</li><li><strong>并发分析</strong>：识别哪些任务可以并行处理，优化系统性能。</li></ul><h2 id="_3-5-用例图-use-case-diagram-需求建模" tabindex="-1">3.5 用例图（Use Case Diagram）：需求建模 <a class="header-anchor" href="#_3-5-用例图-use-case-diagram-需求建模" aria-label="Permalink to &quot;3.5 用例图（Use Case Diagram）：需求建模&quot;">​</a></h2><p>用例图主要用于描述系统的<strong>功能需求</strong>，展示外部参与者（Actor）与系统提供的功能（Use Case）之间的交互关系。它是从用户的角度来描述系统“做什么”，而不关心“怎么做”。</p><h3 id="_1-核心元素-1" tabindex="-1">1. 核心元素 <a class="header-anchor" href="#_1-核心元素-1" aria-label="Permalink to &quot;1. 核心元素&quot;">​</a></h3><table tabindex="0"><thead><tr><th style="text-align:left;">元素</th><th style="text-align:left;">图形符号</th><th style="text-align:left;">说明</th></tr></thead><tbody><tr><td style="text-align:left;"><strong>参与者 (Actor)</strong></td><td style="text-align:left;">小人图标 👤</td><td style="text-align:left;">与系统交互的外部实体（人、外部系统、设备）。</td></tr><tr><td style="text-align:left;"><strong>用例 (Use Case)</strong></td><td style="text-align:left;">椭圆 ⬭</td><td style="text-align:left;">系统提供的某个具体功能或服务。</td></tr><tr><td style="text-align:left;"><strong>系统边界 (System Boundary)</strong></td><td style="text-align:left;">矩形框 □</td><td style="text-align:left;">界定系统的范围，用例在框内，参与者在框外。</td></tr><tr><td style="text-align:left;"><strong>关联 (Association)</strong></td><td style="text-align:left;">实线 —</td><td style="text-align:left;">连接参与者与用例，表示两者有交互。</td></tr></tbody></table><h3 id="_2-用例之间的关系" tabindex="-1">2. 用例之间的关系 <a class="header-anchor" href="#_2-用例之间的关系" aria-label="Permalink to &quot;2. 用例之间的关系&quot;">​</a></h3><ul><li><strong>包含 (Include)</strong>：<code>&lt;&lt;include&gt;&gt;</code>，表示一个用例<strong>必须</strong>包含另一个用例的行为（强制依赖）。</li><li><strong>扩展 (Extend)</strong>：<code>&lt;&lt;extend&gt;&gt;</code>，表示一个用例在<strong>特定条件</strong>下可能会扩展另一个用例的行为（可选增强）。</li><li><strong>泛化 (Generalization)</strong>：空心三角箭头，表示一般与特殊的关系（如“支付”泛化为“微信支付”和“支付宝支付”）。</li></ul><h3 id="_3-简单用例图示例" tabindex="-1">3. 简单用例图示例 <a class="header-anchor" href="#_3-简单用例图示例" aria-label="Permalink to &quot;3. 简单用例图示例&quot;">​</a></h3><p><img src="'+l+'" alt="alt text"></p><h3 id="_4-应用场景-1" tabindex="-1">4. 应用场景 <a class="header-anchor" href="#_4-应用场景-1" aria-label="Permalink to &quot;4. 应用场景&quot;">​</a></h3><ul><li><strong>需求分析</strong>：帮助与客户沟通，明确系统需要提供哪些功能。</li><li><strong>系统边界定义</strong>：明确哪些功能属于系统内部，哪些属于外部交互。</li><li><strong>测试用例设计</strong>：作为编写功能测试用例的基础。</li></ul>',113)]))}const u=a(r,[["render",o]]);export{m as __pageData,u as default};
