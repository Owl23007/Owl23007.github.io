...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    }</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><h5 id="示例补充" tabindex="-1">示例补充 <a class="header-anchor" href="#示例补充" aria-label="Permalink to &quot;示例补充&quot;">​</a></h5><pre class="mermaid mermaid-21">classDiagram
    class Customer {
        -name: String
    }
    class Order {
    ...
    Customer --&gt; &quot;*&quot; Order : places &gt;</pre><p>在上述示例中：</p><ul><li><code>Customer</code> 和 <code>Order</code> 之间是普通关联关系，表示一个客户可以下多个订单。</li><li>用 <code>--&gt;</code> 表示单向关联，箭头指向被引用的类。</li><li><code>&quot;*&quot;</code> 表示多对一关系，即一个客户可以下多个订单。</li></ul><hr><h4 id="_4-聚合关系-aggregation" tabindex="-1">4. 聚合关系（Aggregation） <a class="header-anchor" href="#_4-聚合关系-aggregation" aria-label="Permalink to &quot;4. 聚合关系（Aggregation）&quot;">​</a></h4><p>一种<strong>弱“拥有”关系</strong>，整体与部分可独立存在（“has-a”）。</p><pre class="mermaid mermaid-22">classDiagram
    class Library {
        -name: String
    ...
    Library o-- &quot;*&quot; Book : contains &gt;</pre><ul><li>空心菱形 <code>o--</code> 表示聚合</li><li><code>Book</code> 可脱离 <code>Library</code> 存在（例如被借出或转移到其他图书馆）</li></ul><hr><h4 id="_5-组合关系-composition" tabindex="-1">5. 组合关系（Composition） <a class="header-anchor" href="#_5-组合关系-composition" aria-label="Permalink to &quot;5. 组合关系（Composition）&quot;">​</a></h4><p>一种<strong>强“拥有”关系</strong>，部分生命周期由整体控制（“owns-a”）。</p><pre class="mermaid mermaid-23">classDiagram
    class House {
        +build()
        +demolish()
    }
    ...
    House *-- &quot;*&quot; Room : contains &gt;</pre><ul><li>实心菱形 + 实线 <code>*--</code> 表示组合</li><li><code>Room</code> 不能脱离 <code>House</code> 存在（房子被拆除，房间也随之消失）</li></ul><hr><h4 id="_6-依赖关系-dependency" tabindex="-1">6. 依赖关系（Dependency） <a class="header-anchor" href="#_6-依赖关系-dependency" aria-label="Permalink to &quot;6. 依赖关系（Dependency）&quot;">​</a></h4><p>表示一个类<strong>临时使用</strong>另一个类（如方法参数、局部变量、静态工具调用），耦合最弱。</p><pre class="mermaid mermaid-24">classDiagram
    class Order {
        +process()
    }
